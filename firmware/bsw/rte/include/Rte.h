 ...
 *  MUST be included via -I path to ECU include dir.
 *  Silent fallback to 48 caused buffer overflow (2026-03-26 ThreadX bringup). */
#if __has_include("Rte_PbCfg.h")
#include "Rte_PbCfg.h"
#endif
#ifndef RTE_MAX_SIGNALS
  #ifdef UNIT_TEST
    #define RTE_MAX_SIGNALS    64u   /**< Unit test fallback — sufficient for mocks */
  #else
    #error "Rte_PbCfg.h not found — add ECU include dir to -I path (e.g. -Ifirmware/ecu/fzc/include)"
  #endif
#endif
#ifndef RTE_MAX_RUNNABLES
  #ifdef UNIT_TEST
    #define RTE_MAX_RUNNABLES  16u
  #else
    #error "Rte_PbCfg.h not found — RTE_MAX_RUNNABLES undefined"
  #endif
#endif
